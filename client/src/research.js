...
const causesHBS = {
  ...
  subtitle:
    "Keep track of when you have high and low blood sugar, and tell your doctor.  It may be a sign your treatment needs to change.",
  causes: [
...
const treatingHBS = {
  title: "How to Adjust Your Blood Sugar",
  subtitle:
...
const complications = {
  ...
  listOfComps: [
    ...
    },
    {
      name: "Kidney Disease",
      description:
        "High blood sugar over many years can damage your kidneys and cause them to not work well or stop working completely.",
      recommendation:
    ...
    },
    {
      name: "Eye Diseases",
      description:
        "Poorly controlled diabetes increases your risk of several eye-related conditions, including glaucoma, cataracts, and retinopathy.",
      recommendation:
    ...
    },
    {
      ...
      description:
        "High blood sugar over long periods of time can damage your nerves.  The most common type happens in your legs and feet (called peripheral neuropathy).  Symptoms include pain, sensitivity, and numbness.",
      recommendation:
    ...
    },
    {
      name: "Gum Disease",
      description:
        "Having diabetes and high blood sugar puts you more at risk for bacterial infections, so your gum health can suffer.",
      recommendation:
...
const careSchedule = {
  daily: [
    {
      ...
      description:
        "Check up to several times a day, as directed by your doctor.  Keep a record of your numbers and share them with your health care team during your next visit.",
    },
    {
      title: "Check the Bottoms of Your Feet",
      description:
        "Use a mirror if you can't see the bottom of your feet or ask a family member/caretaker for help.  Let your doctor know immediately if you have any cuts, redness, swelling, sores, blisters, corns, calluses, or other change to the skin or nails.",
    },
    {
    ...
    },
    {
      title: "Exercise",
      description:
        "Get at least 2 and a half hours of moderate activity per week, such as brisk walking or riding a bike.  It is important to raise your heart rate.",
    },
    {
      title: "Eat Healthy",
      description:
  ...
  threeMos: [
    {
      title: "A1C Test",
      description:
        "If your treatment has changed or if you're having trouble meeting your blood sugar goals, test your A1C every 3 months.",
    },
    {
  ...
  sixMos: [
    ...
    },
    {
      title: "A1C Test",
      description:
        "If you're meeting your teatment and blood sugar goals, have this test every 6 months.",
    },
    {
      title: "Visit Your Doctor",
      description:
  ...
  yearly: [
    ...
    },
    {
      title: "Kidney Tests",
      description:
        "Talk to your doctor about checking your kidneys once a year.",
    },
    {
      title: "Cholesterol Test",
      description:
        "Talk to you doctor about checking your cholesterol levels once a year, or more frequently if you have high cholesterol.",
    },
    {
  ...
  asNeeded: [
    {
      ...
      description:
        "Your mental health is just as important as your physical health.  If you're feeling sad or hopeless, let your doctor know right away so that you can get the help that you need.",
    },
    {
      title: "New symptoms or health problems",
      description:
        "If you notice new halth problems or if existing problems are getting worse, call your doctor immediately so that you can be evaluated.",
    },
  ],
};
